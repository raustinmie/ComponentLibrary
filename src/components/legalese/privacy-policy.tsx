...
export default function PrivacyPolicy() {
	const policy = (
		<div>
			...
			<p>
				Through third-party analytics services (such as Google Analytics), we
				may collect:
				<ul>
					<li>IP address</li>
				...
				These analytics tools use cookies or similar technologies to help us
			...
			<h2>5. Cookies</h2>
			<p>
				Our site uses cookies to enable analytics functionality. By using our
				site, you consent to our use of cookies. You can control cookie settings
